...
ALL_FUNCTIONS = FILE_FUNCTIONS + DIR_FUNCTIONS + AI_FUNCTIONS + SHELL_FUNCTIONS + MEMORY_FUNCTIONS
...
MEMORY_TOOLS = [function_to_schema(f) for f in MEMORY_FUNCTIONS] 

ALL_TOOLS = FILE_TOOLS + DIR_TOOLS + AI_TOOLS + SHELL_TOOLS + MEMORY_TOOLS
